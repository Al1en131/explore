...
@media (max-width: 768px) {
  ...
  .hero-title {
    font-size: clamp(3.3rem, 10vw, 44px) !important;
  ...
  .legacy-title {
    font-size: clamp(3.2rem, 11vw, 44px) !important;
  ...
  .herman-quote {
    width: 100% !important;
    margin: 0 0 6vw 0 !important;
    font-size: clamp(1.9rem, 6vw, 28px) !important;
  }
  ...
  .gallery-year {
    font-size: clamp(3rem, 8vw, 40px) !important;
  }
